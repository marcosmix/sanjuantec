...
<body>
    <div class="container">
        <p class="titular" >{{$datos['certificacion']}}</p>
        
        <p class="prefijo" >Por el presente certificamos que</p>
        
        
        <p class="datosAlumno">
            <span class="datosAlumno__nombre">{{$datos['nombre']}} </span>
            <span class="datosAlumno__dni"> DNI {{$datos['dni']}}</span>
        </p>
        <section class="contenedor-texto">
            <p>{{$datos['texto']}} {{$datos['certificacion']}}, con una duración de {{$datos['bloque_organizacion']}}.</p>
            <p>San Juan a los {{$datos['fecha']}}. </p>
        </section>
