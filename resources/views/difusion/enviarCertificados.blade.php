    ...
    <form action="{{route('difusion.EnviarCertificados')}}" method="POST" enctype='multipart/form-data'>
        ...
        <div>
            ...
            <div class="div-borde-redondeado margen-superior-60px padding-total-10px">
                ...
                <p>Deben respetar el mismo orden y no se debe colocar encabezado. No pueden faltar los valores de las columnas DNI y email ya que se implementan para realizar el envío. Los otros campos pueden estar en blanco.</p>
